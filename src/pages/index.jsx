				...
				<section className="container mb-12 px-6">
					<div className="relative">
						...
						<div className="absolute bottom-0 left-0 p-6 bg-gray-900 bg-opacity-50 text-white rounded-b-lg w-full">
							<h1 className="text-4xl font-bold font-serif">Welcome to JS College</h1>
							<p>Your journey to mastering JavaScript starts here.</p>
						</div>
					</div>
				</section>
						...
						<ul className="grid grid-cols-1 md:grid-cols-3 gap-6">
							<li className="flex flex-col items-center">
								...
								<p className="leading-relaxed text-center">
									開発環境の構築から、JavaScriptライブラリを用いたさまざまなアプリケーションの開発を学習します。
								</p>
							</li>
							<li className="flex flex-col items-center">
								<Image
								...
								<p className="leading-relaxed text-center">
									オーケストレーションシステムでサーバーにデプロイします。
									これにより、自己修復機能や負荷分散（スケールアウト）を備えたアプリケーションを世界に公開できます。
								</p>
							</li>
							<li className="flex flex-col items-center">
								<Image
								...
								<p className="leading-relaxed text-center">
									アプリケーションに集客するための方法について学習します。
									また、マネタイズ化するための決済機能をアプリケーションに導入します。
								</p>
							</li>
						</ul>
					</div>
				...
				<section className="container mb-12 bg-gray-100 p-6">
					...
					<ul className="grid grid-cols-3 md:grid-cols-4 gap-3 mt-12">
						<li>
							...
							<span className="text-center block font-bold text-xl mt-3">JavaScript</span>
						</li>
						<li>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							<span className="text-center block font-bold text-xl mt-3">React</span>
						</li>
						<li>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							<span className="text-center block font-bold text-xl mt-3">NodeJS</span>
						</li>
						<li>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							<span className="text-center block font-bold text-xl mt-3">Docker</span>
						</li>
					</ul>
				</section>
				...
				<section className="container mb-12 p-6">
					...
					<div className="mt-8 space-y-6">
						<div className="bg-gray-100 p-4 rounded-lg">
							<h3 className="text-xl font-semibold">Q: JS Collegeは初心者でもできますか？</h3>
							<p className="mt-2 text-gray-700">
								A: はい、初心者から上級者まで幅広いレベルに対応したコースを提供しています。
							</p>
						</div>
						<div className="bg-gray-100 p-4 rounded-lg">
							<h3 className="text-xl font-semibold">Q: コースの料金はいくらですか？</h3>
							<p className="mt-2 text-gray-700">
								A: 多くのコースは無料で提供されていますが、一部のプレミアムコースは有料となります。
							</p>
						</div>
						<div className="bg-gray-100 p-4 rounded-lg">
							<h3 className="text-xl font-semibold">
								Q: 個人開発向けとのことですが、就職・転職にも活かせますか？
							</h3>
							<p className="mt-2 text-gray-700">
								A:
								はい、コースはマネタイズ化を目的に説明していますが、習得した技術は企業に就職・転職にも活かせます。
							</p>
						</div>
					</div>
				</section>
